  ...
  const personalInfo = [
    {
      ...
      label: "Full Name",
      value: "Abdulaki Mustefa",
    },
    {
      icon: <Mail className="text-gray-700" />,
      label: "Email",
      value: "abdulakimustefa@gmail.com",
    },
    {
      icon: <Mail className="text-gray-700" />,
      label: "Alternative Email",
      value: "abdulaki@abdulaki.com",
    },
    {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Passionate Computer Science graduate with expertise in React, React
            Native, and modern web technologies. Dedicated to creating
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              I am a recent Computer Science graduate from Haramaya University,
              passionate about software development and technology innovation.
              My journey in tech began with a curiosity about how digital
              solutions can solve real-world problems.
            </p>
            <p>
              During my studies, I developed a strong foundation in programming
              fundamentals, algorithms, and software engineering principles.
              I've worked on various projects including mobile applications, web
              platforms, and AI-powered solutions.
            </p>
            <p>
              I believe in continuous learning and staying updated with the
              latest technologies. My goal is to contribute to meaningful
              projects that have a positive impact on society, particularly in
              areas like education, agriculture, and business solutions.
            </p>
          </div>
        </div>
